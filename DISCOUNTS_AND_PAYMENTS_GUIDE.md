...
3. **גיפט קארד** - גיפט קארד שניתן להשתמש בו בנוסף לקופון
...
### מה זה?
גיפט קארד עם קוד ייחודי וערך כספי. ניתן להשתמש בו **בנוסף לקופון** (או במקום קופון).

### תכונות:
- ✅ **קוד ייחודי** - כל גיפט קארד יש לו קוד ייחודי
...
### דוגמאות:
- גיפט קארד של ₪200 שניתן להשתמש בו בכל הזמנה
- גיפט קארד של ₪500 שניתן להשתמש בו בנוסף לקופון "SUMMER20"
- גיפט קארד עם תאריך תפוגה - תפוגה בעוד שנה

### איך זה אמור לעבוד?
1. הלקוח מוסיף מוצרים לעגלה
2. הלקוח מזין קוד קופון (אופציונלי)
3. הלקוח מזין קוד גיפט קארד
4. המערכת בודקת את הגיפט קארד:
   - האם הקוד קיים?
   - האם הגיפט קארד פעיל?
   - האם הגיפט קארד לא פג תוקף?
   - מה היתרה הנוכחית?
5. אם הכל תקין - הגיפט קארד מוחל
6. הגיפט קארד מוצג כאמצעי תשלום בצ'ק אאוט
...
4. הלקוח מזין קוד גיפט קארד (אופציונלי)
