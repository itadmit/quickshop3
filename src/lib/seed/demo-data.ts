...
export const demoData = {
  ...
  products: [
    ...
    },
    {
      ...
      body_html: '<p>ג\'ינס קלאסי ונוח, מתאים לכל אירוע.</p>',
      vendor: 'אופנה ישראל',
      product_type: 'בגדים',
      status: 'active',
      published_scope: 'web',
      ...
      height: 5,
      sku: 'JEANS-001',
      seo_title: 'ג\'ינס קלאסי - אופנה ישראל',
      seo_description: 'ג\'ינס קלאסי ונוח. זמין בכל הגדלים.',
      tags: ['פופולרי', 'קלאסי'],
      collections: ['clothing'],
      images: [
        {
      ...
      variants: [
        { option1: '30', price: 189.90, inventory_quantity: 10, sku: 'JEANS-001-30' },
        { option1: '32', price: 189.90, inventory_quantity: 15, sku: 'JEANS-001-32' },
        { option1: '34', price: 189.90, inventory_quantity: 10, sku: 'JEANS-001-34' },
        { option1: '36', price: 189.90, inventory_quantity: 5, sku: 'JEANS-001-36' },
      ],
    },
    {
      title: 'סנדלים קיציים',
      handle: 'summer-sandals',
      body_html: '<p>סנדלים נוחים לימי הקיץ החמים.</p>',
      vendor: 'ספורט בע"מ',
      product_type: 'נעליים',
      status: 'active',
      published_scope: 'web',
      ...
      height: 8,
      sku: 'SANDALS-001',
      seo_title: 'סנדלים קיציים - ספורט בע"מ',
      seo_description: 'סנדלים נוחים לקיץ. זמין בגדלים 36-44.',
      tags: ['קיץ', 'פופולרי'],
      collections: ['shoes'],
      images: [
        {
      ...
      variants: [
        { option1: '36', price: 149.90, inventory_quantity: 7, sku: 'SANDALS-001-36' },
        { option1: '38', price: 149.90, inventory_quantity: 8, sku: 'SANDALS-001-38' },
        { option1: '40', price: 149.90, inventory_quantity: 10, sku: 'SANDALS-001-40' },
        { option1: '42', price: 149.90, inventory_quantity: 6, sku: 'SANDALS-001-42' },
        { option1: '44', price: 149.90, inventory_quantity: 4, sku: 'SANDALS-001-44' },
      ],
    },
    {
      title: 'שעון יד אלגנטי',
      handle: 'elegant-watch',
      body_html: '<p>שעון יד אלגנטי מנירוסטה, עמיד במים.</p>',
      vendor: 'אקססוריז פלוס',
      product_type: 'אקססוריז',
      status: 'active',
      published_scope: 'web',
      ...
      height: 5,
      sku: 'WATCH-001',
      seo_title: 'שעון יד אלגנטי - אקססוריז פלוס',
      seo_description: 'שעון יד אלגנטי מנירוסטה.',
      tags: ['VIP', 'קלאסי'],
      collections: ['accessories'],
      images: [
        {
      ...
      options: [
        {
          ...
          position: 1,
          values: [
            { value: 'כסף', position: 1 },
            { value: 'זהב', position: 2 },
          ],
        },
      ],
      variants: [
        { option1: 'כסף', price: 399.90, inventory_quantity: 8, sku: 'WATCH-001-SILVER' },
        { option1: 'זהב', price: 449.90, inventory_quantity: 7, sku: 'WATCH-001-GOLD' },
      ],
    },
    {
      title: 'חולצה מכופתרת',
      handle: 'button-shirt',
      body_html: '<p>חולצה מכופתרת אלגנטית לאירועים רשמיים.</p>',
      vendor: 'אופנה ישראל',
      product_type: 'בגדים',
      status: 'active',
      published_scope: 'web',
      ...
      height: 3,
      sku: 'SHIRT-001',
      seo_title: 'חולצה מכופתרת - אופנה ישראל',
      seo_description: 'חולצה מכופתרת אלגנטית.',
      tags: ['קלאסי', 'אופנה'],
      collections: ['clothing'],
      images: [
        {
      ...
      options: [
        ...
        },
        {
          ...
          values: [
            { value: 'לבן', position: 1 },
            { value: 'תכלת', position: 2 },
          ],
        },
      ],
      variants: [
        { option1: 'S', option2: 'לבן', price: 159.90, inventory_quantity: 5, sku: 'SHIRT-001-S-WHITE' },
        { option1: 'M', option2: 'לבן', price: 159.90, inventory_quantity: 8, sku: 'SHIRT-001-M-WHITE' },
        { option1: 'L', option2: 'לבן', price: 159.90, inventory_quantity: 6, sku: 'SHIRT-001-L-WHITE' },
        { option1: 'S', option2: 'תכלת', price: 159.90, inventory_quantity: 4, sku: 'SHIRT-001-S-BLUE' },
        { option1: 'M', option2: 'תכלת', price: 159.90, inventory_quantity: 5, sku: 'SHIRT-001-M-BLUE' },
        { option1: 'L', option2: 'תכלת', price: 159.90, inventory_quantity: 2, sku: 'SHIRT-001-L-BLUE' },
      ],
    },
    {
      title: 'משקפי שמש',
      handle: 'sunglasses',
      body_html: '<p>משקפי שמש מעוצבים עם הגנה UV מלאה.</p>',
      vendor: 'אקססוריז פלוס',
      product_type: 'אקססוריז',
      status: 'active',
      published_scope: 'web',
      ...
      height: 5,
      sku: 'SUNGLASSES-001',
      seo_title: 'משקפי שמש - אקססוריז פלוס',
      seo_description: 'משקפי שמש מעוצבים עם הגנה UV.',
      tags: ['קיץ', 'אופנה'],
      collections: ['accessories'],
      images: [
        {
      ...
      options: [
        {
          ...
          position: 1,
          values: [
            { value: 'שחור', position: 1 },
            { value: 'חום', position: 2 },
          ],
        },
      ],
      variants: [
        { option1: 'שחור', price: 249.90, inventory_quantity: 12, sku: 'SUNGLASSES-001-BLACK' },
        { option1: 'חום', price: 249.90, inventory_quantity: 8, sku: 'SUNGLASSES-001-BROWN' },
      ],
    },
    {
      title: 'מגבת חוף',
      handle: 'beach-towel',
      body_html: '<p>מגבת חוף גדולה וספיגה.</p>',
      vendor: 'אקססוריז פלוס',
      product_type: 'אקססוריז',
      status: 'active',
      published_scope: 'web',
      ...
      height: 2,
      sku: 'TOWEL-001',
      seo_title: 'מגבת חוף - אקססוריז פלוס',
      seo_description: 'מגבת חוף גדולה וספיגה.',
      tags: ['קיץ', 'חדש'],
      collections: ['accessories'],
      images: [
        {
  ...
  orders: [
    ...
    // Abandoned Orders (pending payment - עגלות נטושות)
    {
      order_name: '#1003',
      order_number: 1003,
      ...
      total_price: 289.80,
      subtotal_price: 289.80,
      total_tax: 0,
      currency: 'ILS',
      customer_email: 'david.cohen@example.com',
      created_hours_ago: 8, // נוצר לפני 8 שעות - נטוש
      line_items: [
        {
          title: 'חולצת טי שירט כותנה',
          quantity: 1,
    ...
    },
    {
      ...
      fulfillment_status: 'unfulfilled',
      total_price: 599.80,
      subtotal_price: 599.80,
      total_tax: 0,
      currency: 'ILS',
      customer_email: 'sarah.levi@example.com',
      created_hours_ago: 24, // נוצר לפני יום - נטוש
      line_items: [
        {
          title: 'נעלי ספורט נוחות',
          quantity: 2,
    ...
    },
    {
      ...
      currency: 'ILS',
      customer_email: 'david.cohen@example.com',
      created_hours_ago: 6, // נוצר לפני 6 שעות - נטוש
      line_items: [
        {
          title: 'חולצת טי שירט כותנה',
          quantity: 1,
          price: 89.90,
          sku: 'TSHIRT-001-XL-BLUE',
        },
      ],
      shipping_address: {
        first_name: 'דוד',
