...
export function CreatePopupDialog({ open, onOpenChange, onSuccess }: CreatePopupDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent maxWidth="2xl" showCloseButton onClose={() => onOpenChange(false)}>
        <form onSubmit={handleSubmit} className="flex flex-col max-h-[90vh]">
          <DialogHeader>
            <DialogTitle>פופאפ חדש</DialogTitle>
            <DialogDescription>צור פופאפ חדש</DialogDescription>
          </DialogHeader>
