...
export default function TrafficSourcesPage() {
  ...
  const handleExport = async () => {
    try {
      ...
      a.href = url;
      a.download = `traffic-sources-${dateRange.start_date}-${dateRange.end_date}.csv`;
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value={`${new Date(Date.now() - 365 * 24 * 60 * 60 * 1000).toISOString().split('T')[0]}_${new Date().toISOString().split('T')[0]}`}>
                שנה אחרונה
              </SelectItem>
            </SelectContent>
          </Select>
