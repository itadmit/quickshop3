  ...
  },
  {
    ...
    reports: [
      ...
      },
      {
        id: 'gift-cards',
        title: 'גיפט קארדים',
        description: 'דוח שימוש בגיפט קארדים',
      ...
      },
      {
        id: 'store-credits',
        title: 'קרדיטים בחנות',
        description: 'דוח קרדיטים שנוצרו ושומשו',
        href: '/reports/store-credits',
        icon: <HiCurrencyDollar className="w-5 h-5" />,
        isNew: true,
      },
      {
        id: 'influencers',
        title: 'משפיענים',
        description: 'ביצועי משפיענים ומכירות',
        href: '/reports/influencers',
        icon: <HiUserGroup className="w-5 h-5" />,
        isNew: true,
      },
    ],
