...
import { HiSave, HiGift, HiPhotograph, HiColorSwatch } from 'react-icons/hi';
    ...
    <div className="p-6 space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">עצב את עיצוב הגיפט קארד במייל</p>
        </div>
      ...
      {/* תצוגה מקדימה */}
      <Card className="p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">תצוגה מקדימה</h2>
