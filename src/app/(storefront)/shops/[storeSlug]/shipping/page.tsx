...
export default async function ShippingPage({
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12" dir="rtl">
      <h1 className="text-4xl font-bold text-gray-900 mb-8">משלוחים והחזרות</h1>
      <div className="prose prose-lg max-w-none text-gray-700">
        <h2 className="text-2xl font-semibold mb-4">משלוחים</h2>
        <p className="mb-4">
          אנו מספקים משלוח מהיר ואמין לכל רחבי הארץ. זמן המשלוח הוא בדרך כלל 2-5 ימי עסקים.
        </p>
        <h2 className="text-2xl font-semibold mb-4 mt-8">החזרות</h2>
        <p className="mb-4">
          אם אינך מרוצה מהמוצר, תוכל להחזיר אותו תוך 14 ימים מהרכישה. אנא צור איתנו קשר להחזרה.
        </p>
      </div>
    </div>
  );
