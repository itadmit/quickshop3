  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12" dir="rtl">
      ...
      <div className="prose prose-lg max-w-none text-gray-700">
        <p className="mb-4">
          אנו מחויבים להגנה על הפרטיות שלך. המידע שאתה מספק לנו משמש רק למטרות שירות לקוחות ושיפור החוויה שלך.
        </p>
        <p className="mb-4">
          אנו לא נמכור או נשתף את המידע האישי שלך עם צדדים שלישיים ללא הסכמתך המפורשת.
        </p>
      </div>
    </div>
  );
