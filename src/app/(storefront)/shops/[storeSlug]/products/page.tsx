...
// ============================================
// Products Page - Optimized with Cache & Translations
// ============================================
...
export default async function ProductsPage({
  ...
  // טעינת מוצרים עם JOINs מיטביים (Single Query)
...
function Pagination({ currentPage, totalPages, storeSlug, search }: PaginationProps) {
  ...
  return (
    <div className="flex justify-center items-center gap-2 mt-8">
      {currentPage > 1 && (
        <a
          href={`/shops/${storeSlug}/products?page=${currentPage - 1}${searchParam}`}
      ...
      {pages.map((page) => (
        <a
          key={page}
          href={`/shops/${storeSlug}/products?page=${page}${searchParam}`}
