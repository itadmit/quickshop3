      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="space-y-2">
          ...
          <button
            ...
            className="w-full mt-4 px-4 py-2 border-2 border-dashed border-gray-300 rounded-lg text-sm text-gray-600 hover:border-green-500 hover:text-green-600 transition-colors flex items-center justify-center gap-2"
          >
              ...
              <div className="grid grid-cols-2 gap-2">
                {Object.entries(dynamicWidgets).map(([key, widget]) => (
                  <button
                    ...
                    className="px-4 py-3 text-right border border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition-colors"
                  >
                    <div className="font-medium text-gray-900">{widget.name}</div>
                    <div className="text-xs text-green-600 mt-1">{widget.variable}</div>
                  </button>
                ))}
              </div>
            </div>
